...
<body>
    ...
    <!--home-contant-->
    <section class="h-[100vh] w-full flex justify-around flex-wrap ">

        <div class=" w-[40%] h-[60%] my-[10%] ">
            <h1 class="text-[50px] font-extrabold mb-5">BIENVENU DANS CIH BANK</h1>
            <p class="text-justify">Lorem ipsum dolor sit amet consectetur adipisicing elit. Et, exercitationem? Lorem
                ipsum dolor
                sit
                amet,
                consectetur adipisicing elit. Dolorem, aperiam.</p>

            <button type="button"
                class=" mt-10 text-white bg-gradient-to-br from-amber-600 to-blue-600 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-amber-600 dark:focus:ring-amber-600 font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 mb-2">Decouvrire
                Nos Service</button>

        </div>
        <div class="  w-[40%] h-[60%] my-[10%] bg-[url('image/home.jpg')] bg-no-repeat bg-cover"></div>
