...
<body>
    ...
    <section class="bg-gray-50 dark:bg-white">
        <div class="flex flex-col items-center justify-center px-6 py-8 mx-auto md:h-screen lg:py-0">
            <a href="#">
                <img class="w-64 h-32  " src="../image/logo.png" alt="logo">
            </a>
            <div
                class="w-full  bg-white rounded-lg shadow-2xl  md:mt-0 sm:max-w-md xl:p-0 dark:bg-blue-300 dark:border-gray-700">
