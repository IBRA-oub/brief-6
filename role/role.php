...
<body>
    ...
    <nav
        ...
        <div class="mr-10 pt-2 font-bold text-gray-500 cursor-pointer ">
            ...
            <ul class="flex justify-around">
                ...
                <li class="pr-5 hover:text-amber-500"><a href="#" class="px-5 py-1 text-amber-500">Role</a></li>
                ...
                <li class="pr-5 hover:text-amber-500"><a href="../adminDestributeur/adminDestributeur.php"
                        class="px-5 py-1 text-amber-500  ">Distributeurs</a>
                </li>
    ...
    <div class="relative overflow-x-auto shadow-md ">
        <table class="w-full text-sm text-left  text-black  border-t-4 border-slate-700">
